...
@section('title', 'Ajouter un Cours - Admin')
...
@section('content')
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-black text-[#0a1033] mt-2">Ajouter un cours de langue</h1>
    </div>

    <form action="{{ route('admin.courses.store') }}" method="POST" class="bg-white rounded-3xl border border-gray-200 p-6 sm:p-8">
        @csrf
